						...
						<div class="col-lg-12">
							<div class="single-product clearfix">
								...
								<div class="single-pro-slider single-big-photo view-lightbox slider-for">
									<div>
										<img src="{{asset('img/single-product/medium/1.jpg')}} " alt="" />
										<a class="view-full-screen" href="{{asset('img/single-product/large/1.jpg')}} "  data-lightbox="roadtrip" data-title="My caption">
											<i class="zmdi zmdi-zoom-in"></i>
										</a>
									</div>
									<div>
										<img src="{{asset('img/single-product/medium/2.jpg')}} " alt="" />
										<a class="view-full-screen" href="{{asset('img/single-product/large/2.jpg')}} "  data-lightbox="roadtrip" data-title="My caption">
											<i class="zmdi zmdi-zoom-in"></i>
										</a>
									</div>
									<div>
										<img src="{{asset('img/single-product/medium/3.jpg')}} " alt="" />
										<a class="view-full-screen" href="{{asset('img/single-product/large/3.jpg')}} "  data-lightbox="roadtrip" data-title="My caption">
											<i class="zmdi zmdi-zoom-in"></i>
										</a>
									</div>
									<div>
										<img src="{{asset('img/single-product/medium/4.jpg')}} " alt="" />
										<a class="view-full-screen" href="{{asset('img/single-product/large/4.jpg')}} "  data-lightbox="roadtrip" data-title="My caption">
											<i class="zmdi zmdi-zoom-in"></i>
										</a>
									</div>
									<div>
										<img src="{{asset('img/single-product/medium/5.jpg')}} " alt="" />
										<a class="view-full-screen" href="{{asset('img/single-product/large/5.jpg')}} "  data-lightbox="roadtrip" data-title="My caption">
											<i class="zmdi zmdi-zoom-in"></i>
										</a>
									</div>
								</div>	
								...
								<div class="product-info">
									...
									<div class="single-pro-slider single-sml-photo slider-nav">
										<div>
											<img src="{{asset('img/single-product/small/1.jpg')}} " alt="" />
										</div>
										<div>
											<img src="{{asset('img/single-product/small/2.jpg')}} " alt="" />
										</div>
										<div>
											<img src="{{asset('img/single-product/small/3.jpg')}} " alt="" />
										</div>
										<div>
											<img src="{{asset('img/single-product/small/4.jpg')}} " alt="" />
										</div>
										<div>
											<img src="{{asset('img/single-product/small/5.jpg')}} " alt="" />
										</div>
									</div>
