<section class="mb-5">
    <h2 class=" text-center m-5">Créer un nouveau Blog <a class="text-success" href="/article/create"> CLICK HERE</a></h2>
      ...
      <table class="table  table-danger">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {{-- {{dd($item->blog->src)}} --}}
                  <img style="width: 50px; height: 50px;" src="{{asset('/thumbnail/images/270x230/'. $item->blog->src)}}" alt=""> </td>
