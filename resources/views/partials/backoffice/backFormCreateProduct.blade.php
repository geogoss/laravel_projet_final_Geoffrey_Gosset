<section class="w-50 mx-auto mb-5">
    <h1 class="text-center my-5"><a class="text-decoration-none text-dark  " href="/backProduct">Voir tous les produits
            👉</a></h1>
    <div class="bg-success py-5">
        ...
        <form class="w-75 mx-auto text-white" action="/product" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input name="price" type="number" class="form-control" id="addTreeInputMax"
                    aria-describedby="addTreeInputMaxHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Discount</label>
                <input name="discount" type="number" class="form-control" id="exampleInputEmail1"
            ...
            <p class="mb-3">
                <input type="checkbox" id="newsletter" name="bool" checked>
